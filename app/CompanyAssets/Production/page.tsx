...
// Pages
import AddAccountForm from "../../../components/CompanyAssets/Production/AddProductionForm";
import SearchFilters from "../../../components/CompanyAssets/Production/SearchFilters";
import ContainerTable from "../../../components/CompanyAssets/Production/ProductionTable";
...
const ContainerList: React.FC = () => {
    ...
    const fetchDatabase = async () => {
        try {
            const response = await fetch("/api/CompanyAssets/Production/FetchRecord");
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`/api/CompanyAssets/Production/DeleteRecord`, {
                method: "DELETE",
                headers: {
