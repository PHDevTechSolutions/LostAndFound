...
// Pages
import AddAccountForm from "../../../components/Purchasing/AddPurchasingForm";
import SearchFilters from "../../../components/Container/SearchFilters";
import ContainerTable from "../../../components/Purchasing/PurchasingTable";
...
const ContainerList: React.FC = () => {
    ...
    const fetchDatabase = async () => {
        try {
            const response = await fetch("/api/Purchasing/FetchRecord");
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`/api/Purchasing/DeleteRecord`, {
                method: "DELETE",
                headers: {
