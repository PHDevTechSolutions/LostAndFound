...
import Table from "../../../components/Report/Approval/ApprovalItemsTable";
import SearchFilters from "../../../components/Report/Approval/SearchFilters";
                        ...
                        <div className="container mx-auto p-4">
                            <div className="grid grid-cols-1 md:grid-cols-1">
                                {showForm ? (
                                    ...
                                    <>
                                        <h2 className="text-lg font-bold mb-2">School Approval for Lost Items</h2>
