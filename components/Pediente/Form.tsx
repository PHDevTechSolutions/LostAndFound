...
const Form: React.FC<FormProps> = ({ totalPayment, totalBalance }) => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        const formData = {
            addReceivable: formatCurrency(0),
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex flex-wrap mx-auto mt-4 mb-4 border p-4 shadow-md rounded-md">
                    <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                        ...
                        <input type="text" id="AddReceivable" value={formatCurrency(0)} className="w-full px-3 py-2 border rounded text-xs bg-gray-100" readOnly />
                    </div>
                    <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
