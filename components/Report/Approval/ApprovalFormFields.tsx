    ...
    return (
        <>
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                    <label className="block text-xs font-bold mb-2" htmlFor="ItemProgress">Progress</label>
                    <select id="ItemProgress" value={ItemProgress || ""} onChange={(e) => setItemProgress(e.target.value)} className="w-full px-3 py-2 border rounded text-xs uppercase" required>
