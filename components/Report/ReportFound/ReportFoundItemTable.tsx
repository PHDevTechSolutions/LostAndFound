                ...
                <tbody>
                    {paginatedPosts.map((post) => (
                        <tr key={post._id} className="text-left border-b capitalize">
                            ...
                            <td className="p-2 border">{post.DateFound}</td>
                            <td className="p-2 border">{post.ItemName}</td>
                            <td className="p-2 border">{post.FoundLocation}</td>
                            <td className="p-2 border">{post.Message}</td>
                            <td className="p-2 border">{post.ItemOwner}</td>
                            <td className="p-2 border">{post.ItemFinder}</td>
