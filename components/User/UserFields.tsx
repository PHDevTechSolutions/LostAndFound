...
const UserFields: React.FC<UserFieldsProps> = ({ Firstname, setFirstname, Lastname, setLastname, Email, setEmail, Location, setLocation, UserName, setUserName, Password, setPassword, Role, setRole }) => {
    return (
        ...
        <div className="mb-4">
            ...
            <input type="text" id="Firstname" value={Firstname} onChange={(e) => setFirstname(e.target.value)} className="w-full px-3 py-2 border rounded text-xs" />
        </div> 
        <div className="mb-4">
            <label className="block text-xs font-bold mb-2" htmlFor="lastname">Lastname</label>
            <input type="text" id="Lastname" value={Lastname} onChange={(e) => setLastname(e.target.value)} className="w-full px-3 py-2 border rounded text-xs" />
        </div> 
        <div className="mb-4">
        ...
        <div className="mb-4">
            ...
            <input type="text" id="Location" value={Location} onChange={(e) => setLocation(e.target.value)} className="w-full px-3 py-2 border rounded text-xs" />
        </div> 
        <div className="mb-4">
        ...
        <div className="mb-4">
            ...
            <input type="text" id="Role" value={Role} onChange={(e) => setRole(e.target.value)} className="w-full px-3 py-2 border rounded text-xs" />
        </div> 
        </>
    )
