            ...
            <form onSubmit={handleSubmit}>
                <div className="flex flex-wrap mx-auto mt-4 mb-4 border p-4 shadow-md rounded-md">
                    <div className="w-full sm:w-1/2 md:w-1/5 px-4 mb-4">
                        <label className="block text-xs font-bold mb-2" htmlFor="AddReceivable">Beginning Balance</label>
                        <input type="text" id="AddReceivable" value={formatCurrency(beginningBalance)} className="w-full px-3 py-2 border rounded text-xs bg-gray-100" readOnly />
                    </div>
                    <div className="w-full sm:w-1/2 md:w-1/5 px-4 mb-4">
