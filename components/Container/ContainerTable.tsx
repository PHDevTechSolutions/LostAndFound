...
const ContainerTable: React.FC<ContainerTableProps> = ({ posts, handleEdit, handleDelete }) => {
                    ...
                    {updatedPosts.length > 0 ? (
                        updatedPosts.map((post) => (
                            <React.Fragment key={post._id}>
                                ...
                                >
                                    <td className="px-4 py-2 border"><BsPlusCircle className="inline-block mr-2 md:hidden " /> {post.SpsicNo}</td>
