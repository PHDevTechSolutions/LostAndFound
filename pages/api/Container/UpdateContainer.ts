...
export default async function editAccount(req: NextApiRequest, res: NextApiResponse) {
    ...
    const { id, ContainerNo, ReferenceNumber, ContainerType, Size, Commodity, Username, Location, DateOrder, BuyersName, BoxSales, Price, Remaining, GrossSales, PlaceSales, PaymentMode, Freezing } = req.body;
    ...
    try {
        ...
        const updatedAccount = {
            ContainerNo, ReferenceNumber, ContainerType, Size, Commodity, Username, Location, DateOrder, BuyersName, BoxSales, Price, Remaining, GrossSales, PlaceSales, PaymentMode, Freezing, updatedAt: new Date(),
        };
